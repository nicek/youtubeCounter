...
// Your config below!
// =======================================================================
const char* ssid     = "2.4G-Nicki";               // SSID of local network
const char* password = "nicus1990";             // Password on network
String ytApiV3Key = "AIzaSyCLQMaoJL4NVknRuJS5UQe8s_-_IlCUMr4";                // YouTube Data API v3 key generated here: https://console.developers.google.com
String channelId = "UCu_jL4REqfuDICm2c4CLLSg";   // YT channel id
long utcOffset = 2;                              // for Warsaw,Poland
// =======================================================================
...
void loop()
{
  ...
  printStringWithShift("  Subskrybcje: ",scrollDel,font,' ');
  printValueWithShift(subscriberCount,scrollDel,0);
  delay(del);
  if(subsGain1h) {
    printStringWithShift("  Przyrost subskrybcji 1h: ",scrollDel,font,' ');
    printValueWithShift(subsGain1h,scrollDel,1);
    delay(del);
  }
  if(subsGain24h) {
    printStringWithShift("  Przyrost subskrybcji 24h: ",scrollDel,font,' '); 
    printValueWithShift(subsGain24h,scrollDel,1);
    delay(del);
  }
  printStringWithShift("  Wyświetlenia: ",scrollDel,font,' ');
  printValueWithShift(viewCount,scrollDel,0);
  delay(del);
//  printStringWithShift("  Filmy: ",scrollDel,font,' ');
